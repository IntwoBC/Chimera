codeunit 60004 "Import Investran File"
{
    ...
    begin
        ...
        for RowNo := 2 to MaxRowNo do begin
            ...
            RecInvestranStaggingL."GL Date" := GetValueAsDate(GetValueAtCell(RowNo, 6));
            RecInvestranStaggingL."GL Account" := GetValueAtCell(RowNo, 7);
            RecInvestranStaggingL."Batch ID" := GetValueAtCell(RowNo, 8);
            RecInvestranStaggingL.Debits := GetValueAsDecimal(GetValueAtCell(RowNo, 9));
            RecInvestranStaggingL.Credits := GetValueAsDecimal(GetValueAtCell(RowNo, 10));
            RecInvestranStaggingL."Comments Batch" := GetValueAtCell(RowNo, 11);
            RecInvestranStaggingL."Cash Account" := GetValueAtCell(RowNo, 12);
